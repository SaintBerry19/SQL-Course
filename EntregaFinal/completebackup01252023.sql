...
CREATE TABLE `CLIENTES` (
  ...
  CONSTRAINT `clientes_ibfk_1` FOREIGN KEY (`empresa_id`) REFERENCES `EMPRESA` (`empresa_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `compra_detallada` (
  ...
  CONSTRAINT `compra_detallada_ibfk_1` FOREIGN KEY (`compra_id`) REFERENCES `COMPRAS` (`compra_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `compra_detallada_ibfk_2` FOREIGN KEY (`material_id`) REFERENCES `MATERIALES` (`material_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `compras` (
  ...
  CONSTRAINT `compras_ibfk_1` FOREIGN KEY (`trabajador_proveedor_id`) REFERENCES `TRABAJADOR_PROVEEDOR` (`trabajador_proveedor_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `materiales` (
  ...
  CONSTRAINT `materiales_ibfk_1` FOREIGN KEY (`proveedor_id`) REFERENCES `PROVEEDOR` (`proveedor_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `trabajador_proveedor` (
  ...
  UNIQUE KEY `identificacion_nacional` (`identificacion_nacional`),
  KEY `proveedor_id` (`proveedor_id`),
  CONSTRAINT `trabajador_proveedor_ibfk_1` FOREIGN KEY (`proveedor_id`) REFERENCES `PROVEEDOR` (`proveedor_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=201 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `venta_detallada` (
  ...
  KEY `venta_id` (`venta_id`),
  KEY `material_id` (`material_id`),
  CONSTRAINT `venta_detallada_ibfk_1` FOREIGN KEY (`venta_id`) REFERENCES `VENTAS` (`venta_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `venta_detallada_ibfk_2` FOREIGN KEY (`material_id`) REFERENCES `MATERIALES` (`material_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2023-01-22 17:20:59
